...
import com.tygx.device.hik.lib.RECT;
import com.tygx.device.hik.lib.W32API;
import com.tygx.device.hik.lib.W32API.HWND;
...
public interface HCNetSDK extends Library {
	...
	class SdkUnion extends Union {
		@Override
		protected  List<String> getFieldOrder(){
			List<String> fieldOrderList = new ArrayList<String>();
			for (Class<?> cls = getClass();
				 !cls.equals(SdkUnion.class);
				 cls = cls.getSuperclass()) {
				Field[] fields = cls.getDeclaredFields();
				int modifiers;
				for (Field field : fields) {
...
/************************************多路解码器(end)***************************************/
    ...
    public static class VIDEOWALLWINDOWPOSITION_ARRAY extends SdkStructure {
...
//NET_DVR_Login()参数结构
    ...
    public static class NET_DVR_FIND_PICTURE extends SdkStructure {
    ...
    public static class NET_DVR_SETUPALARM_PARAM_V50 extends SdkStructure {
        public int dwSize;
        public byte byLevel; //布防优先级，0-一等级（高），1-二等级（中），2-三等级（低）
        public byte byAlarmInfoType; //上传报警信息类型（抓拍机支持），0-老报警信息（NET_DVR_PLATE_RESULT），1-新报警信息(NET_ITS_PLATE_RESULT)2012-9-28
        public byte byRetAlarmTypeV40; //0--返回NET_DVR_ALARMINFO_V30或NET_DVR_ALARMINFO, 1--设备支持NET_DVR_ALARMINFO_V40则返回NET_DVR_ALARMINFO_V40，不支持则返回NET_DVR_ALARMINFO_V30或NET_DVR_ALARMINFO
    ...
    */
    ...
    //快速移动参数
    public static class NET_VCA_RUN extends SdkStructure {
        public NET_VCA_POLYGON struRegion;//区域范围
    ...
    */
    ...
    //奔跑检测
    public static class NET_VCA_RUNNING extends SdkStructure {
        public NET_VCA_POLYGON struRegion;  //区域范围
    ...
    //倒地参数
    public static class NET_VCA_FALL_DOWN extends SdkStructure {
        public NET_VCA_POLYGON struRegion;//区域范围
    ...
    // AI开放平台接入轮询视频检测报警结构体。
    public static class NET_AIOP_POLLING_SNAP_HEAD extends SdkStructure {
    ...
    // AI开放平台接入轮询视频检测报警结构体。
    public static class NET_AIOP_POLLING_VIDEO_HEAD extends SdkStructure {
    ...
    */
    ...
    public static class NET_DVR_FINGERPRINT_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FINGERPRINT_RECORD extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FINGERPRINT_STATUS extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CAPTURE_FINGERPRINT_COND extends SdkStructure {
        public int dwSize;
    ...
    //
    public static class NET_DVR_CAPTURE_FINGERPRINT_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FINGER_PRINT_INFO_CTRL_V50 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FINGER_PRINT_BYREADER_V50 extends SdkStructure {
    ...
    public static class NET_DVR_FINGER_PRINT_BYCARD_V50 extends SdkStructure {
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //指纹关联的卡号
    ...
    //指纹删除控制参数结构体
    public static class NET_DVR_FINGER_PRINT_INFO_CTRL extends SdkStructure {
        public int dwSize;
        public byte byMode;          //删除方式，0-按卡号方式删除，1-按读卡器删除
        public byte[] byRes1 = new byte[3];        //保留
    ...
    public static class NET_DVR_FINGER_PRINT_BYCARD extends SdkStructure {
    ...
    public static class NET_DVR_FINGER_PRINT_BYREADER extends SdkStructure {
    ...
    //门禁主机参数
    public static class NET_DVR_ACS_CFG extends SdkStructure {
        public int dwSize;            //结构体大小
     ...
     * 优化接口结构体定义结束
     ***************************/
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_COND extends SdkStructure {
        public int dwSize;
        public int dwBlockListNum; //禁止名单数量
        public byte[] byRes = new byte[128];
    }

    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_STATUS extends SdkStructure {
        public int dwSize;
    ...
    public static class REMOTECONFIGSTATUS extends SdkStructure {
    ...
    public static class NET_DVR_ACS_PARAM_TYPE extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_GROUP_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_MULTI_CARD_CFG_V50 extends SdkStructure {
        public int dwSize;
        public byte byEnable;
    ...
    public static class NET_DVR_MULTI_CARD_GROUP_CFG_V50 extends SdkStructure {
        public byte byEnable;
    ...
    public static class NET_DVR_GROUP_COMBINATION_INFO_V50 extends SdkStructure {
        public byte byEnable;
    ...
    //TPS实时过车数据上传
    public static class NET_DVR_TPS_REAL_TIME_INFO extends SdkStructure {
        public int dwSize;          // 结构体大小
        public int dwChan;//通道号
    ...
    //实时信息
    public static class NET_DVR_TPS_PARAM extends SdkStructure {
        public byte byStart;          // 开始码
    ...
    //温差报警
    public static class NET_DVR_THERMOMETRY_DIFF_ALARM extends SdkStructure {
        public int dwSize;
        public int dwChannel;//通道号
    ...
    //船只检测报警上传
    public static class NET_DVR_SHIPSDETECTION_ALARM extends SdkStructure {
        public int dwSize;
    ...
    //船只信息
    public static class NET_DVR_SHIPSINFO extends SdkStructure {
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    public static class INT_ARRAY extends SdkStructure {
        public int[] intValue;
    ...
    public static class INTRef_ARRAY extends SdkStructure {
    ...
    public static class NET_DVR_CAMERAPARAMCFG_EX extends SdkStructure {
        public int dwSize;
    ...
    */
    ...
    public static class NET_DVR_VIDEOEFFECT extends SdkStructure {
    ...
    public static class NET_DVR_GAIN extends SdkStructure {
    ...
    public static class NET_DVR_WHITEBALANCE extends SdkStructure {
...
14-白炽灯 (IncandescentLamp)，15-暖光灯(Warm Light Lamp)，16-自然光(Natural Light) */
    ...
    public static class NET_DVR_EXPOSURE extends SdkStructure {
    ...
    public static class NET_DVR_GAMMACORRECT extends SdkStructure {
    ...
    public static class NET_DVR_WDR extends SdkStructure {
    ...
    public static class NET_DVR_DAYNIGHT extends SdkStructure {
    ...
    public static class NET_DVR_BACKLIGHT extends SdkStructure {
    ...
    public static class NET_DVR_NOISEREMOVE extends SdkStructure {
    ...
    public static class NET_DVR_CMOSMODECFG extends SdkStructure {
    ...
    public static class NET_DVR_DEFOGCFG extends SdkStructure {
        public byte byMode; //模式，0-不启用，1-自动模式，2-常开模式
        public byte byLevel; //等级，0-100
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_CMOSMODCFG extends SdkStructure {
        public byte byCaptureMod;   //抓拍模式：0-抓拍模式1；1-抓拍模式2
        public byte byBrightnessGate;//亮度阈值
        public byte byCaptureGain1;   //抓拍增益1,0-100
        public byte byCaptureGain2;   //抓拍增益2,0-100
    ...
    public static class NET_DVR_ELECTRONICSTABILIZATION extends SdkStructure {
        public byte byEnable;//使能 0- 不启用，1- 启用
        public byte byLevel; //等级，0-100
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_CORRIDOR_MODE_CCD extends SdkStructure {
        public byte byEnableCorridorMode; //是否启用走廊模式 0～不启用， 1～启用
        public byte[] byRes = new byte[11];
    }

    public static class NET_DVR_SMARTIR_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_PIRIS_PARAM extends SdkStructure {
        public byte byMode;//0-自动，1-手动
        public byte byPIrisAperture;//红外光圈大小等级(等级,光圈大小正比例)level:1~100 默认:50（手动模式下增加）
        public byte[] byRes = new byte[6];
    }

    public static class NET_DVR_LASER_PARAM_CFG extends SdkStructure {
    ...
    public static class NET_DVR_FFC_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_DDE_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_AGC_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_SNAP_CAMERAPARAMCFG extends SdkStructure {
    ...
    public static class NET_DVR_OPTICAL_DEHAZE extends SdkStructure {
        public byte byEnable; //0~不启用光学透雾，1~启用光学透雾
        public byte[] byRes = new byte[7];
    }

    public static class NET_DVR_THERMOMETRY_AGC extends SdkStructure {
    ...
    public static class NET_DVR_CHECK_DEV_STATE extends SdkStructure {
    ...
    public static class NET_DVR_FLOW_INFO extends SdkStructure {
        public int dwSize;             //结构大小
    ...
    public static class NET_DVR_AES_KEY_INFO extends SdkStructure {
        public byte[] sAESKey = new byte[16];        /*码流加密密钥*/
        public byte[] byRes = new byte[64];          /*保留字节*/
    }

    public static class NET_DVR_ALARM_RS485CFG extends SdkStructure {
        public int dwSize;                 // 结构体大小
    ...
    public static class NET_DVR_ALARMHOST_RS485_SLOT_CFG extends SdkStructure {
        public int dwSize;              // 结构体大小
        public byte[] sDeviceName = new byte[NAME_LEN];      // 前端设备名称
    ...
    public static class NET_DVR_VIDEOWALLDISPLAYPOSITION extends SdkStructure {
        public int dwSize;
        public byte byEnable;
    ...
    public static class NET_DVR_DISPLAYCFG extends SdkStructure {
        public int dwSize;
        public NET_DVR_DISPLAYPARAM[] struDisplayParam = new NET_DVR_DISPLAYPARAM[MAX_DISPLAY_NUM];
        public byte[] byRes2 = new byte[128];
    }

    public static class NET_DVR_DISPLAYPARAM extends SdkStructure {
        public int dwDisplayNo;
        public byte byDispChanType;
        public byte[] byRes = new byte[11];
    }

    public static class NET_DVR_WALLOUTPUTPARAM extends SdkStructure {
        public int dwSize;
    ...
    public static class WALLOUTPUTPARAM_ARRAY extends SdkStructure {
...
//2007-11-30 V211支持以下接口 //11
     ...
     */
    //设备抓图附加全屏测温数据结构体
    public static class NET_DVR_JPEGPICTURE_WITH_APPENDDATA extends SdkStructure {
        public int dwSize;
        public int dwChannel;//通道号
    ...
    public static class DATE_TIME extends SdkStructure {
    ...
    //全屏测温数据解析
    public static class STREAM_RT_DATA_INFO_S extends SdkStructure {
    ...
    public static class STREAM_FS_SUPPLE_INFO_TEMP extends SdkStructure {
    ...
    public static class STREAM_FARME_INFO_TEMP extends SdkStructure {
    ...
    //测温规则温度信息
    public static class NET_DVR_THERMOMETRYRULE_TEMPERATURE_INFO extends SdkStructure {
        public float fMaxTemperature;
        public float fMinTemperature;
        public float fAverageTemperature;
        public NET_VCA_POINT struHighestPoint;
    ...
    public static class REMOTECONFIGSTATUS_THERMOMETRY extends SdkStructure {
        public byte[] byStatus = new byte[4];
        public byte[] byErrorCode = new byte[4];
    }

    public static class NET_DVR_FIREDETECTION_ALARM extends SdkStructure {
        public int dwSize; //结构体大小
        public int dwRelativeTime; //相对时标
        public int dwAbsTime; //绝对时标
        public NET_VCA_DEV_INFO struDevInfo; //前端设备信息
    ...
    //模块服务配置结构体
    public static class NET_DVR_DEVSERVER_CFG extends SdkStructure {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_UPLOAD_FILE_RET extends SdkStructure {

        public byte[] sUrl = new byte[MAX_UPLOADFILE_URL_LEN];   //url
        public byte[] byRes = new byte[260];
    }

    public static class NET_DVR_FLOW_TEST_PARAM extends SdkStructure {
        public int dwSize;              //结构大小
    ...
    public static class NET_DVR_RECORD_TIME_SPAN_INQUIRY extends SdkStructure {
        public int dwSize;    //结构体大小
        public byte byType;     //0 正常音视频录像, 1图片通道录像, 2ANR通道录像, 3抽帧通道录像
        public byte[] byRes = new byte[63];
    }

    public static class NET_DVR_RECORD_TIME_SPAN extends SdkStructure {
        public int dwSize;        //结构体大小
     ...
     * 月历录像分布查询条件结构体
     */
    public static class NET_DVR_MRD_SEARCH_PARAM extends SdkStructure {
        public int dwSize;            // 结构体大小
     ...
     * 月历录像分布查询结果结构体
     */
    public static class NET_DVR_MRD_SEARCH_RESULT extends SdkStructure {
    ...
    public static class NET_DVR_GIS_INFO extends SdkStructure {
        public int dwSize;
    ...
    //GBT28181协议的设备编码通道配置
    public static class NET_DVR_GBT28181_CHANINFO_CFG extends SdkStructure {
        public int dwSize;
    ...
    // 巡航路径配置条件结构体
    public static class NET_DVR_CRUISEPOINT_COND extends SdkStructure {
        public int dwSize;
        public int dwChan;
    ...
    // 巡航路径配置结构体
    public static class NET_DVR_CRUISEPOINT_V40 extends SdkStructure {
        public int dwSize;
    ...
    // 巡航路径配置结构体
    public static class NET_DVR_CRUISEPOINT_V50 extends SdkStructure {
        public int dwSize;
    ...
    // 巡航点参数结构体
    public static class NET_DVR_CRUISEPOINT_PARAM extends SdkStructure {
        public short wPresetNo;
        public short wDwell;
        public byte bySpeed;
