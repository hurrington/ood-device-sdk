...
public class DEV_EVENT_HEAT_IMAGING_TEMPER_INFO extends NetSDKLib.SdkStructure {
	 ...
	 * {@link com.ood.device.dh.lib.enumeration.NET_RADIOMETRY_RESULT}
	 */
	public int emResult;
	/**
	 * 报警条件 {@link com.ood.device.dh.lib.enumeration.NET_RADIOMETRY_ALARMCONTION}
	 */
	...
	/**
	 * 温度单位(当前配置的温度单位) {@link com.ood.device.dh.lib.NetSDKLib.NET_TEMPERATURE_UNIT }
	 */
