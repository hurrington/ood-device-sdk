...
public class NET_SECURITYGATE_ALARM_FACE_INFO extends NetSDKLib.SdkStructure{
    ...
    /**
     *  性别,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_SEX_TYPE }
     */
    public int emSex;				// 性别
    public   int											nAge; // 年龄
    /**
     *  人脸表情,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_EXPRESSION_TYPE }
     */
    public int emEmotion;			// 人脸表情

    /**
     *  是否戴眼镜,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_GLASSES_TYPE }
     */
