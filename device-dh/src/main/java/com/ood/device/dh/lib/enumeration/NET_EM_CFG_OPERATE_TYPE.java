package com.ood.device.dh.lib.enumeration;

import com.ood.device.dh.lib.NetSDKLib;
import com.ood.device.dh.lib.structure.NET_CFG_HEALTH_CODE_INFO;
...
public class NET_EM_CFG_OPERATE_TYPE {
    ...
    /**
     * 合成通道配置, 对应结构体{@link com.ood.device.dh.lib.structure.NET_COMPOSE_CHANNEL_INFO}
     */
    public static final int NET_EM_CFG_COMPOSE_CHANNEL = 1401;                   // 合成通道配置, 对应结构体 NET_COMPOSE_CHANNEL_INFO
    /**
     * 司法刻录参数, 对应结构体 {@link com.ood.device.dh.lib.structure.NET_BURN_PARAM_INFO}
     */
    ...
    /**
     * 门禁节假日组配置, 对应结构体 {@link com.ood.device.dh.lib.structure.NET_CFG_ACCESSCTL_SPECIALDAY_GROUP_INFO}
     */
    ...
    /**
     * 广告禁用时段配置, 对应结构体 {@link com.ood.device.dh.lib.structure.NET_CFG_FORBIDDEN_ADVERT_PLAY}, 通道无关，通道号填-1
     */
    public static final int NET_EM_CFG_FORBIDDEN_ADVERT_PLAY = 3906;             // 广告禁用时段配置, 对应结构体 NET_CFG_FORBIDDEN_ADVERT_PLAY, 通道无关，通道号填-1
    /**
     * 门禁设备当前模式配置, 对应结构体 {@link com.ood.device.dh.lib.structure.NET_CFG_BGY_CUSTOMERCFG}, 通道无关，通道号填-1
     */
