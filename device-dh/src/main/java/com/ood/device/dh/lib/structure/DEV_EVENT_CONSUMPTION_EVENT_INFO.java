...
public			int					nBlockId;
/**
事件类型   {@link com.ood.device.dh.lib.NetSDKLib.NET_ACCESS_CTL_EVENT_TYPE }
*/
public			int					emType;
/**
消费结果   {@link com.ood.device.dh.lib.enumeration.EM_CONSUMPTION_STATUS }
*/
public			int					emStatus;
/**
卡类型  {@link com.ood.device.dh.lib.NetSDKLib.NET_ACCESSCTLCARD_TYPE }
*/
public			int					emCardType;
/**
用户类型  {@link com.ood.device.dh.lib.NetSDKLib.EM_USER_TYPE }
*/
public			int					emUserType;
/**
卡状态   {@link com.ood.device.dh.lib.NetSDKLib.NET_ACCESSCTLCARD_STATE }
*/
public			int					emCardStatus;
/**
开门方式      {@link com.ood.device.dh.lib.NetSDKLib.NET_ACCESS_DOOROPEN_METHOD }
*/
public			int					emMethod;
/**
卡号
...
/**
记录类型  {@link com.ood.device.dh.lib.enumeration.EM_CONSUMPTION_EVENT_TYPE }
*/
