...
public class NET_VKINFO extends NetSDKLib.SdkStructure {
	...
	/**
	 * 加密算法类型 {@link com.ood.device.dh.lib.enumeration.EM_ALGORITHM_TYPE}
	 */
	...
	/**
	 * 是否加密 {@link com.ood.device.dh.lib.enumeration.EM_IS_ENCRYPT}
	 */
	public int emIsEncrypt;
	/**
	 * 是否是当前VK 0 ：未知，1：当前， 2：之前 {@link com.ood.device.dh.lib.enumeration.EM_IS_CURRENT_VK}
	 */
