...
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.MAX_MASKTYPE_COUNT;
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.MAX_MOSAICTYPE_COUNT;
...
public class CFG_PTZ_PRIVACY_MASKING extends NetSDKLib.SdkStructure {
     ...
     * 枚举参考{@link com.ood.device.dh.lib.enumeration.NET_EM_MASK_TYPE}
     */
     ...
     * 枚举值参考{@link com.ood.device.dh.lib.enumeration.NET_EM_MOSAIC_TYPE}
     */
