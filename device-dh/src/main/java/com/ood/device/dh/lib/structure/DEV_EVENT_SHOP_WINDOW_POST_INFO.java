...
import static com.ood.device.dh.lib.NetSDKLib.HDBJ_MAX_OBJECTS_NUM;
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.SDK_MAX_DETECT_REGION_NUM;

/**
 * @author 47081
 * @version 1.0
 * @description 事件类型
 * {@link com.ood.device.dh.lib.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_WINDOW_POST}(橱窗张贴事件)对应的数据块描述信息
 * @date 2020/11/16
 */
