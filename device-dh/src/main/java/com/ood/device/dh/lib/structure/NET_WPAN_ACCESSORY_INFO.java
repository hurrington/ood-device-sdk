...
/**
探测器状态 {@link com.ood.device.dh.lib.enumeration.EM_DETECTOR_STATUS_TYPE}
*/
public			int					emState;
/**
设备布防时音量 {@link com.ood.device.dh.lib.enumeration.EM_ACCESSORY_VOLUME}
*/
public			int					emBeepVolume;
/**
灵敏度 {@link com.ood.device.dh.lib.enumeration.EM_ACCESSORY_SENSITIVITY}
*/
public			int					emSensentivity;
/**
功率调节 {@link com.ood.device.dh.lib.enumeration.EM_POWER_REGULATION_TYPE}
*/
public			int					emPowerRegulation;
/**
在线状态 {@link com.ood.device.dh.lib.enumeration.EM_ONLINE_STATUS}
*/
public			int					emOnline;
/**
报警类型 {@link com.ood.device.dh.lib.enumeration.EM_ACCESSORY_ALARM_TYPE}
*/
public			int					emAlarmType;
/**
输入类型 {@link com.ood.device.dh.lib.enumeration.EM_ACCESSORY_INPUT_TYPE}
*/
public			int					emInputType;
/**
LED亮度 {@link com.ood.device.dh.lib.enumeration.EM_LED_BRIGHTNESS_LEVEL}
*/
public			int					emLedBrightnessLevel;
/**
操作模式 {@link com.ood.device.dh.lib.enumeration.EM_OPERATION_MODE}
*/
public			int					emOperationMode;
/**
防误按模式 {@link com.ood.device.dh.lib.enumeration.EM_ANTI_MISPRESS_TYPE}
*/
public			int					emAntiMispress;
/**
外部电源状态，若未开启检测外接电源状态则为未知 {@link com.ood.device.dh.lib.enumeration.EM_EXPOWER_STATE}
*/
public			int					emExPowerState;
/**
设备报警音量 {@link com.ood.device.dh.lib.enumeration.EM_ACCESSORY_VOLUME}
*/
public			int					emVolume;
/**
环境温度，单位：摄氏度
...
/**
传感器感应方式 {@link com.ood.device.dh.lib.enumeration.EM_BUTTON_ALARM_TYPE}
*/
public			int					emType;
/**
心跳信息
