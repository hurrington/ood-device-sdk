...
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
...
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 门禁通道单双向配置,对应枚举{@link com.ood.device.dh.lib.enumeration.CFG_ACCESS_PROPERTY_TYPE} */
