...
public enum EM_NEW_CONFIG {
  ...
  /** 语音激励(对应 {@link com.ood.device.dh.lib.structure.CFG_AUDIO_SPIRIT}) */
  CFG_CMD_AUDIO_SPIRIT("AudioSpirit"),
  /** 设备安装位置的GPS坐标信息(对应 {@link com.ood.device.dh.lib.structure.CFG_DEVLOCATION_INFO}) */
  CFG_CMD_DEVLOCATION("DevLocation"),
  /** 设备参数标定配置(对应 {@link com.ood.device.dh.lib.structure.CFG_LOCATION_CALIBRATE_INFO}) */
  CFG_CMD_LOCATION_CALIBRATE("LocationCalibrate"),
  /** // 门禁基本配置(对应 {@link com.ood.device.dh.lib.structure.CFG_ACCESS_GENERAL_INFO}) */
