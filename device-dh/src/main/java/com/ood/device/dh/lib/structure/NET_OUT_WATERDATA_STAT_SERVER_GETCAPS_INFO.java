...
public			int					dwSize;
/**
当前是否具备水质检测功能 {@link com.ood.device.dh.lib.enumeration.EM_WATERDATA_STAT_SERVER_SUPPORT}
*/
public			int					emSupport;
/**
是否支持本地存储 {@link com.ood.device.dh.lib.enumeration.EM_SUPPORT_LOCALDATA_STORE}
*/
