...
public class DEV_EVENT_TRAFFIC_TRAFFICCAR_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 车辆行驶方向 {@link com.ood.device.dh.lib.enumeration.EM_TRAFFICCAR_MOVE_DIRECTION}
     */
    ...
    /**
     * 车辆类型 {@link com.ood.device.dh.lib.enumeration.EM_TRAFFICCAR_CAR_TYPE}
     */
    public int emCarType;
    /**
     * 车道类型 {@link com.ood.device.dh.lib.enumeration.EM_TRAFFICCAR_LANE_TYPE}
     */
    ...
    /**
     * 收费公路车辆通行费车型分类 {@link com.ood.device.dh.lib.enumeration.EM_TOLLS_VEHICLE_TYPE}
     */
