...
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.DH_MAX_DETECT_REGION_NUM;
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.HDBJ_MAX_OBJECTS_NUM;

/**
 * @author 47081
 * @version 1.0
 * @description 事件类型
 * {@link com.ood.device.dh.lib.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_SIGN_ABNORMAL}(店招异常事件)对应的数据块描述信息
 * @date 2020/11/17
 */
