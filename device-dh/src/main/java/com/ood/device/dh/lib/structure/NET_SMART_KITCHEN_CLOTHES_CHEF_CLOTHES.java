...
public class NET_SMART_KITCHEN_CLOTHES_CHEF_CLOTHES extends NetSDKLib.SdkStructure{
    ...
    public int[] emHasChefClothes=new int[3];       /** 是否有带厨师服 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
	public int[] emChefClothesColor=new int[3];	    /** 厨师服颜色 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_COLOUR} */
