...
import static com.ood.device.dh.lib.NetSDKLib.CFG_COMMON_STRING_32;
import static com.ood.device.dh.lib.constant.SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN;
...
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 支持的支持的焦距模式掩码,从低位到高位依次数,见{@link com.ood.device.dh.lib.enumeration.EM_SUPPORT_FOCUS_MODE}
     */
