...
public class DEV_EVENT_SECURITYGATE_PERSONALARM_INFO extends NetSDKLib.SdkStructure {
	...
	/**
	 * 人员通过方向枚举,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_PERSON_PASS_DIRECTION }
	 */
	public int emDirection; // 人员通过方向

	/**
	 * 报警级别,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_ALARM_LEVEL }
	 */
	...
	/**
	 * 报警位置,参考枚举{@link com.ood.device.dh.lib.enumeration.EM_SECURITYGATE_ALARM_POSITION }
	 */
