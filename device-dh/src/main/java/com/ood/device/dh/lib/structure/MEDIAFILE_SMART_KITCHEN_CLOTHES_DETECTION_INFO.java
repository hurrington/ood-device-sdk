...
public class MEDIAFILE_SMART_KITCHEN_CLOTHES_DETECTION_INFO extends NetSDKLib.SdkStructure{
    ...
    public  int emHasMask;               /** 厨师口罩状态 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public 	int	emHasChefHat;           /** 厨师帽状态 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public 	int  emHasChefClothes;   /** 厨师服状态 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_STATE} */
    public  int emChefClothesColor;      /**厨师服颜色 {@link com.ood.device.dh.lib.enumeration.EM_SMART_KITCHEN_CLOTHES_COLOUR} */
